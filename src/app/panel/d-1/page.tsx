  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-white uppercase">Módulo D-1</h1>
          <p className="text-muted-foreground mt-1">Préstamos que vencen el día de mañana.</p>
        </div>
