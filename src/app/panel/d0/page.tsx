  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <h1 className="text-3xl font-bold tracking-tight text-primary uppercase">Módulo D0</h1>
        <div className="flex items-center space-x-3">
          ...
          <Badge variant="outline" className="px-4 py-2 text-primary border-primary/20 bg-primary/5 font-bold">{filteredPrestamos.length} PARA HOY</Badge>
        </div>
      </div>
      ...
      <div className="grid gap-4">
        {filteredPrestamos.length === 0 && !loading ? (
          <Card className="bg-card/30 border-dashed border-border p-16 text-center">
            ...
            <h3 className="text-xl font-bold text-white">Sin cobros para hoy</h3>
          </Card>
                ...
                <div className="flex items-center space-x-5">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-4 mt-2 text-sm">
                      ...
                      <span className="flex items-center text-primary font-bold"><CalendarCheck className="h-4 w-4 mr-1.5" />Vence: Hoy</span>
                    </div>
                  </div>
                </div>
